...
sealed interface Requirement {
    ...
    data class Troublesome(val day: String, val hour: Int, val hour2: Int, val name1: String, val name2: String): Requirement
}
...
fun createSolver2(teacherCalendar: Calendar, studentInfo: List<StudentInfo>, troublesomes: List<Pair<String, String>>) : MrsKnuth2Solver {
...
fun main() {
    ...
    val troublesomes = (0 until readln().toInt()).map { readln().split(" ") }.map { it[0] to it[1] }

    createSolver2(teacherSchedule, studentInfos, troublesomes).solve()
}